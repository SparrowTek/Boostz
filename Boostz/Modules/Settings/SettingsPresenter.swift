    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("This policy applies to all information collected or submitted on Boostz’s website and our apps for iPhone and any other devices and platforms.")
                
                WebSectionView(title: "Information we collect", content: """
                Boostz does not create any accounts.
                ...
                Boostz’s app may collect aggregate, anonymous statistics, such as the percentage of users who use particular features, to improve the app.
                """)
                
                WebSectionView(title: "Information usage", content: """
                We use the information we collect to operate and improve our website, apps, and customer support.

                We do not share personal information with outside parties except to the extent necessary to accomplish Boostz’s functionality.
...
Boostz displays links and content from third-party sites. These have their own independent privacy policies, and we have no responsibility or liability for their content or activities.
""")
...
By using Boostz and providing your information, you authorize us to collect, use, and store your information outside of the European Union.
""")
